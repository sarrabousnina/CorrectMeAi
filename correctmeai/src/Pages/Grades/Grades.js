...
export default function Grades() {
    ...
    const filtered = useMemo(() => {
        ...
        f = [...f].sort((a, b) => {
            if (by === "student")
                return String(a.student).localeCompare(String(b.student)) * dir;
            if (by === "date")
                return (new Date(a.updatedAt || 0) - new Date(b.updatedAt || 0)) * dir;
                            ...
                            <div className="seg">
                                <button
                                    ...
                                    onClick={() =>
                                        setSort((s) => ({
                                            by: "score",
                                            dir: s.by === "score" && s.dir === "desc" ? "asc" : "desc",
                                        }))
                                    }
                                >
                                ...
                                <button
                                    ...
                                    onClick={() =>
                                        setSort((s) => ({
                                            by: "date",
                                            dir: s.by === "date" && s.dir === "desc" ? "asc" : "desc",
                                        }))
                                    }
                                >
                                    Date {sort.by === "date" ? (sort.dir === "desc" ? "↓" : "↑") : ""}
                                </button>
                            </div>
