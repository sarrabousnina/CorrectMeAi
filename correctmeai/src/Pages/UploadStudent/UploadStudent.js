        ...
        <div className="upload-student">
            ...
            >
                ...
                <div className="us-row">
                    <div className="us-label">Attach to exam:</div>
                    <select
                ...
                >
                    {filesWithIndex.length === 0 ? (
                        ...
                        <>
                            <p className="us-reorder-hint">
                                🟰 Drag the images to reorder them before submitting
                            </p>
                            <ReactSortable list={filesWithIndex} setList={setFilesWithIndex} className="us-gallery">
                                {filesWithIndex.map((item, index) => (
                                    <div key={item.id} className="us-thumb">
                                        <div className="us-thumb-index">{index + 1}</div>
                ...
                <div className="us-footer">
                    ...
                    <label htmlFor="file" className="us-filelabel">
                        {filesWithIndex.length > 0
                            ? `${filesWithIndex.length} file(s) selected`
                            : "Not selected file"}
                    </label>

                    <button type="button" className="us-clear" onClick={handleClear} title="Clear selection">
                        Clear
                    </button>
                </div>
